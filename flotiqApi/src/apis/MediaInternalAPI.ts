...
export class MediaInternalAPI extends runtime.BaseAPI {
     ...
     */
    async batchDeleteRaw(requestParameters: MediaInternalAPIBatchDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlogpostBatchDelete200Response>> {
        const queryParameters: any = {};
     ...
     * Delete a batch of _media objects
     */
    async batchDelete(requestParameters: MediaInternalAPIBatchDeleteRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BlogpostBatchDelete200Response> {
