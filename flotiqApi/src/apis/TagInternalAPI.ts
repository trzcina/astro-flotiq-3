...
export class TagInternalAPI extends runtime.BaseAPI {
     ...
     */
    async batchDeleteRaw(requestParameters: TagInternalAPIBatchDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlogpostBatchDelete200Response>> {
        const queryParameters: any = {};
     ...
     * Delete a batch of _tag objects
     */
    async batchDelete(requestParameters: TagInternalAPIBatchDeleteRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BlogpostBatchDelete200Response> {
