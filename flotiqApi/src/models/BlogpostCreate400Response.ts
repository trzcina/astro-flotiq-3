 ...
 */
export function instanceOfBlogpostCreate400Response(value: object): value is BlogpostCreate400Response {
...
export function BlogpostCreate400ResponseFromJSON(json: any): BlogpostCreate400Response {
    return BlogpostCreate400ResponseFromJSONTyped(json, false);
}

export function BlogpostCreate400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostCreate400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function BlogpostCreate400ResponseToJSON(value?: BlogpostCreate400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
