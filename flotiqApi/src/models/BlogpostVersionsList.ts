 ...
 */
export function instanceOfBlogpostVersionsList(value: object): value is BlogpostVersionsList {
...
export function BlogpostVersionsListFromJSON(json: any): BlogpostVersionsList {
    return BlogpostVersionsListFromJSONTyped(json, false);
}

export function BlogpostVersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostVersionsList {
    if (json == null) {
        return json;
    }
    return {
...
export function BlogpostVersionsListToJSON(value?: BlogpostVersionsList | null): any {
    if (value == null) {
        return value;
    }
    return {
