 ...
 */
export function instanceOfBlogpostList400Response(value: object): value is BlogpostList400Response {
...
export function BlogpostList400ResponseFromJSON(json: any): BlogpostList400Response {
    return BlogpostList400ResponseFromJSONTyped(json, false);
}

export function BlogpostList400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostList400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function BlogpostList400ResponseToJSON(value?: BlogpostList400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
