...
export interface BlogpostWithoutInternal {
     ...
     * @memberof BlogpostWithoutInternal
     */
    header_image?: Array<DataSource>;
}

/**
 * Check if a given object implements the BlogpostWithoutInternal interface.
 */
export function instanceOfBlogpostWithoutInternal(value: object): value is BlogpostWithoutInternal {
...
export function BlogpostWithoutInternalFromJSON(json: any): BlogpostWithoutInternal {
    return BlogpostWithoutInternalFromJSONTyped(json, false);
}

export function BlogpostWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostWithoutInternal {
    if (json == null) {
        return json;
    }
    return {
        ...
        'header_image': json['header_image'] == null ? undefined : ((json['header_image'] as Array<any>).map(DataSourceFromJSON)),
    };
}

export function BlogpostWithoutInternalToJSON(value?: BlogpostWithoutInternal | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'header_image': value['header_image'] == null ? undefined : ((value['header_image'] as Array<any>).map(DataSourceToJSON)),
    };
}
