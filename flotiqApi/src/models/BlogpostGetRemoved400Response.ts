 ...
 */
export function instanceOfBlogpostGetRemoved400Response(value: object): value is BlogpostGetRemoved400Response {
...
export function BlogpostGetRemoved400ResponseFromJSON(json: any): BlogpostGetRemoved400Response {
    return BlogpostGetRemoved400ResponseFromJSONTyped(json, false);
}

export function BlogpostGetRemoved400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostGetRemoved400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function BlogpostGetRemoved400ResponseToJSON(value?: BlogpostGetRemoved400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
