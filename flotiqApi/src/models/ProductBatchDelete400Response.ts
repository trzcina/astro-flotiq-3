 ...
 */
export function instanceOfProductBatchDelete400Response(value: object): value is ProductBatchDelete400Response {
    ...
    if (flotiqContentType) {
        const typeSlug = flotiqContentType.split('_')
            ...
            .join('');
        return 'ProductBatchDelete400Response' === typeSlug;
    }
    return true;
}
