...
export function BlogpostListFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostList {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(BlogpostFromJSON)),
    };
}

export function BlogpostListToJSON(value?: BlogpostList | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(BlogpostToJSON)),
    };
}
