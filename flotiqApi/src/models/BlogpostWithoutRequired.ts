 ...
 */
export function instanceOfBlogpostWithoutRequired(value: object): value is BlogpostWithoutRequired {
...
export function BlogpostWithoutRequiredFromJSON(json: any): BlogpostWithoutRequired {
    return BlogpostWithoutRequiredFromJSONTyped(json, false);
}

export function BlogpostWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostWithoutRequired {
    if (json == null) {
        return json;
    }
    return {
...
export function BlogpostWithoutRequiredToJSON(value?: BlogpostWithoutRequired | null): any {
    if (value == null) {
        return value;
    }
    return {
