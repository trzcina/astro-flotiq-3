 ...
 */
export function instanceOfBlogpostDelete400Response(value: object): value is BlogpostDelete400Response {
...
export function BlogpostDelete400ResponseFromJSON(json: any): BlogpostDelete400Response {
    return BlogpostDelete400ResponseFromJSONTyped(json, false);
}

export function BlogpostDelete400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostDelete400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function BlogpostDelete400ResponseToJSON(value?: BlogpostDelete400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
