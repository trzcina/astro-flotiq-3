...
export function BlogpostFromJSONTyped(json: any, ignoreDiscriminator: boolean): Blogpost {
    ...
    return {
        ...
        'header_image': json['header_image'] == null ? undefined : ((json['header_image'] as Array<any>).map(MediaFromJSON)),
    };
}
...
export function BlogpostToJSON(value?: Blogpost | null): any {
    ...
    return {
        ...
        'header_image': value['header_image'] == null ? undefined : ((value['header_image'] as Array<any>).map(MediaToJSON)),
    };
}
