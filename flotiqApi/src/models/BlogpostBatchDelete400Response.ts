 ...
 */
export function instanceOfBlogpostBatchDelete400Response(value: object): value is BlogpostBatchDelete400Response {
...
export function BlogpostBatchDelete400ResponseFromJSON(json: any): BlogpostBatchDelete400Response {
    return BlogpostBatchDelete400ResponseFromJSONTyped(json, false);
}

export function BlogpostBatchDelete400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostBatchDelete400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function BlogpostBatchDelete400ResponseToJSON(value?: BlogpostBatchDelete400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
