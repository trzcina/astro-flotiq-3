 ...
 */
export function instanceOfBlogpostBatchDelete200Response(value: object): value is BlogpostBatchDelete200Response {
...
export function BlogpostBatchDelete200ResponseFromJSON(json: any): BlogpostBatchDelete200Response {
    return BlogpostBatchDelete200ResponseFromJSONTyped(json, false);
}

export function BlogpostBatchDelete200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlogpostBatchDelete200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function BlogpostBatchDelete200ResponseToJSON(value?: BlogpostBatchDelete200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
